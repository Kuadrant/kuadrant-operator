...
func mainAuthPolicyIssuerURLMutator(desired, existing *kuadrantv1.AuthPolicy) bool {
	...
	if !reflect.DeepEqual(existing.Spec.Overrides.AuthPolicySpecProper.AuthScheme.Authentication["oidc"].AuthenticationSpec.AuthenticationMethodSpec.Jwt.IssuerUrl, desired.Spec.Overrides.AuthPolicySpecProper.AuthScheme.Authentication["oidc"].AuthenticationSpec.AuthenticationMethodSpec.Jwt.IssuerUrl) {
		existing.Spec.Overrides.AuthPolicySpecProper.AuthScheme.Authentication["oidc"].AuthenticationSpec.AuthenticationMethodSpec.Jwt.IssuerUrl = desired.Spec.Overrides.AuthPolicySpecProper.AuthScheme.Authentication["oidc"].AuthenticationSpec.AuthenticationMethodSpec.Jwt.IssuerUrl
		existing.Spec.Overrides.AuthPolicySpecProper.AuthScheme.Authorization["oidc"].AuthorizationSpec.CommonEvaluatorSpec.Conditions[0].CelPredicate.Predicate = desired.Spec.Overrides.AuthPolicySpecProper.AuthScheme.Authorization["oidc"].AuthorizationSpec.CommonEvaluatorSpec.Conditions[0].CelPredicate.Predicate
		update = true
	}
