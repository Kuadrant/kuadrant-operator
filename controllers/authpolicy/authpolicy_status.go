...
func (r *Reconciler) reconcileStatus(ctx context.Context, ap *api.AuthPolicy, specErr error) (ctrl.Result, error) {
...
func (r *Reconciler) calculateStatus(ctx context.Context, ap *api.AuthPolicy, specErr error) *api.AuthPolicyStatus {
...
func (r *Reconciler) acceptedCondition(policy kuadrant.Policy, specErr error) *metav1.Condition {
...
func (r *Reconciler) enforcedCondition(ctx context.Context, policy *api.AuthPolicy) *metav1.Condition {
	logger, _ := logr.FromContext(ctx)
...
func (r *Reconciler) isAuthConfigReady(ctx context.Context, policy *api.AuthPolicy) (bool, error) {
...
func (r *Reconciler) handlePolicyOverride(policy *api.AuthPolicy) *metav1.Condition {
