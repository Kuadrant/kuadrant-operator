...
var _ = Describe("DNSPolicy Single Cluster", func() {
	...
	var clusterID, recordName, wildcardRecordName string
					...
					ContainElements(
						MatchFields(IgnoreExtras, Fields{
							...
							"Spec": MatchFields(IgnoreExtras, Fields{
								...
								"Endpoints": ConsistOf(
									PointTo(MatchFields(IgnoreExtras, Fields{
										"DNSName":       Equal(cgwTarget.GetName() + "-" + cgwTarget.GetShortCode() + "." + "klb.test.example.com"),
									...
									PointTo(MatchFields(IgnoreExtras, Fields{
										...
										"Targets":          ConsistOf(clusterID + "-" + cgwTarget.GetShortCode() + "." + "klb.test.example.com"),
										"RecordType":       Equal("CNAME"),
										"SetIdentifier":    Equal(clusterID + "-" + cgwTarget.GetShortCode() + "." + "klb.test.example.com"),
										"RecordTTL":        Equal(externaldns.TTL(60)),
						...
						MatchFields(IgnoreExtras, Fields{
							...
							"Spec": MatchFields(IgnoreExtras, Fields{
								...
								"Endpoints": ContainElements(
									PointTo(MatchFields(IgnoreExtras, Fields{
										"DNSName":       Equal(clusterID + "-" + cgwTarget.GetShortCode() + "." + "klb.example.com"),
										"Targets":       ConsistOf(TestIPAddressOne, TestIPAddressTwo),
										"RecordType":    Equal("A"),
										"SetIdentifier": Equal(""),
										"RecordTTL":     Equal(externaldns.TTL(60)),
									...
									PointTo(MatchFields(IgnoreExtras, Fields{
										...
										"Targets":          ConsistOf(clusterID + "-" + cgwTarget.GetShortCode() + "." + "klb.example.com"),
										"RecordType":       Equal("CNAME"),
										"SetIdentifier":    Equal(clusterID + "-" + cgwTarget.GetShortCode() + "." + "klb.example.com"),
										"RecordTTL":        Equal(externaldns.TTL(60)),
										"ProviderSpecific": Equal(externaldns.ProviderSpecific{{Name: "weight", Value: "120"}}),
									})),
									PointTo(MatchFields(IgnoreExtras, Fields{
