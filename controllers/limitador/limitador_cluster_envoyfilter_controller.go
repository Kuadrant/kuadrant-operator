...
// ClusterEnvoyFilterReconciler reconciles a EnvoyFilter object with limitador's cluster
type ClusterEnvoyFilterReconciler struct {
...
func (r *ClusterEnvoyFilterReconciler) Reconcile(eventCtx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
func (r *ClusterEnvoyFilterReconciler) reconcileRateLimitingClusterEnvoyFilter(ctx context.Context, gw *gatewayapiv1.Gateway) error {
...
func (r *ClusterEnvoyFilterReconciler) desiredRateLimitingClusterEnvoyFilter(ctx context.Context, gw *gatewayapiv1.Gateway) (*istioclientnetworkingv1alpha3.EnvoyFilter, error) {
...
func (r *ClusterEnvoyFilterReconciler) SetupWithManager(mgr ctrl.Manager) error {
