...
func translatePolicy(crt *certmanv1.Certificate, tlsPolicy v1alpha2.TLSPolicySpec) {
...
func validateIssuer(ctx context.Context, k8sClient client.Client, policy *v1alpha2.TLSPolicy) error {
