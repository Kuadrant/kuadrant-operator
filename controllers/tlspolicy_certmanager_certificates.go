...
func (r *TLSPolicyReconciler) reconcileCertificates(ctx context.Context, tlsPolicy *v1.TLSPolicy, gwDiffObj *reconcilerutils.GatewayDiffs) error {
...
func (r *TLSPolicyReconciler) createOrUpdateGatewayCertificates(ctx context.Context, tlspolicy *v1.TLSPolicy, expectedCertificates []*certmanv1.Certificate) error {
...
func (r *TLSPolicyReconciler) deleteGatewayCertificates(ctx context.Context, gateway *gatewayapiv1.Gateway, tlsPolicy *v1.TLSPolicy) error {
...
func (r *TLSPolicyReconciler) deleteCertificates(ctx context.Context, tlsPolicy *v1.TLSPolicy) error {
...
func (r *TLSPolicyReconciler) deleteUnexpectedCertificates(ctx context.Context, expectedCertificates []*certmanv1.Certificate, gateway *gatewayapiv1.Gateway, tlsPolicy *v1.TLSPolicy) error {
...
func expectedCertificatesForGateway(ctx context.Context, gateway *gatewayapiv1.Gateway, tlsPolicy *v1.TLSPolicy) []*certmanv1.Certificate {
	log := crlog.FromContext(ctx)
...
func expectedCertificatesForListener(l *machinery.Listener, tlsPolicy *v1.TLSPolicy) []*certmanv1.Certificate {
	tlsHosts := make(map[corev1.ObjectReference][]string)
...
func buildCertManagerCertificate(gateway *gatewayapiv1.Gateway, tlsPolicy *v1.TLSPolicy, secretRef corev1.ObjectReference, hosts []string) *certmanv1.Certificate {
...
func commonTLSCertificateLabels(gwKey client.ObjectKey, p *v1.TLSPolicy) map[string]string {
...
func policyTLSCertificateLabels(p *v1.TLSPolicy) map[string]string {
