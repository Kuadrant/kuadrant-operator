...
func (r *TLSPolicyReconciler) reconcileResources(ctx context.Context, tlsPolicy *v1.TLSPolicy, targetNetworkObject client.Object) error {
...
func (r *TLSPolicyReconciler) deleteResources(ctx context.Context, tlsPolicy *v1.TLSPolicy, targetNetworkObject client.Object) error {
