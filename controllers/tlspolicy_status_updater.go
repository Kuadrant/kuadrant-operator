...
func (t *TLSPolicyStatusUpdaterReconciler) UpdateStatus(ctx context.Context, _ []controller.ResourceEvent, topology *machinery.Topology, _ error, s *sync.Map) error {
	...
	policies := lo.FilterMap(topology.Policies().Items(), func(item machinery.Policy, index int) (*kuadrantv1.TLSPolicy, bool) {
		p, ok := item.(*kuadrantv1.TLSPolicy)
		return p, ok
	})
...
func (t *TLSPolicyStatusUpdaterReconciler) enforcedCondition(ctx context.Context, tlsPolicy *kuadrantv1.TLSPolicy, topology *machinery.Topology) *metav1.Condition {
...
func (t *TLSPolicyStatusUpdaterReconciler) isIssuerReady(ctx context.Context, tlsPolicy *kuadrantv1.TLSPolicy, topology *machinery.Topology) error {
