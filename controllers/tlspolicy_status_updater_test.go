...
func TestTLSPolicyStatusTask_enforcedCondition(t *testing.T) {
	...
	policyFactory := func(mutateFn ...func(policy *kuadrantv1alpha2.TLSPolicy)) *kuadrantv1alpha2.TLSPolicy {
		p := &kuadrantv1alpha2.TLSPolicy{
			...
			TypeMeta: metav1.TypeMeta{
				Kind:       "TLSPolicy",
				APIVersion: kuadrantv1alpha2.GroupVersion.String(),
			},
			Spec: kuadrantv1alpha2.TLSPolicySpec{
				CertificateSpec: kuadrantv1alpha2.CertificateSpec{
	...
	withClusterIssuerMutater := func(p *kuadrantv1alpha2.TLSPolicy) {
	...
	topologyOpts := func(policy *kuadrantv1alpha2.TLSPolicy, additionalOps ...machinery.GatewayAPITopologyOptionsFunc) []machinery.GatewayAPITopologyOptionsFunc {
	...
	type args struct {
		tlsPolicy *kuadrantv1alpha2.TLSPolicy
		topology  func(*kuadrantv1alpha2.TLSPolicy) *machinery.Topology
	}
	tests := []struct {
		name string
		args args
	...
	}{
		{
			...
			args: args{
				...
				topology: func(p *kuadrantv1alpha2.TLSPolicy) *machinery.Topology {
		...
		},
		{
			...
			args: args{
				tlsPolicy: policyFactory(),
				topology: func(_ *kuadrantv1alpha2.TLSPolicy) *machinery.Topology {
		...
		},
		{
			...
			args: args{
				tlsPolicy: policyFactory(),
				topology: func(policy *kuadrantv1alpha2.TLSPolicy) *machinery.Topology {
