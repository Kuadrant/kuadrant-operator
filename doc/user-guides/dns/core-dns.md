...
Refer to the [CLI documentation](https://github.com/Kuadrant/dns-operator/blob/main/docs/cli.md) for instructions on installing the CLI.
...
# Then inspect the authoritative record (replace <authoritative-record-name> with the name generated by the previous listing commands)
