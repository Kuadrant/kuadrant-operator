...
```sh
kubectl port-forward -n gateway-system service/external-istio 9081:80 2>&1 >/dev/null &
kubectl port-forward -n gateway-system service/internal-istio 9082:80 2>&1 >/dev/null &
```
