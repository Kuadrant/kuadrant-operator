...
```
curl -k -H "'Host: api.${KUADRANT_ZONE_ROOT_DOMAIN}'" "https://$GATEWAY_URL/cars" -i
...
```
for i in {1..10}; do curl -k -H "'Host: api.${KUADRANT_ZONE_ROOT_DOMAIN}'" "https://$GATEWAY_URL/cars" -i; done
```
