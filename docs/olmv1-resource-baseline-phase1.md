...
| `limitador-operator-controller-manager` | `control-plane: controller-manager` | `app: limitador-operator`, `control-plane: controller-manager` | `limitador-operator-controller-manager` | `quay.io/kuadrant/limitador-operator:latest` | `Kuadrant/kuadrant` |
