...
func (r *KuadrantStatusUpdater) calculateStatus(topology *machinery.Topology, logger logr.Logger, kObj *kuadrantv1beta1.Kuadrant, state *sync.Map) *kuadrantv1beta1.KuadrantStatus {
	newStatus := &kuadrantv1beta1.KuadrantStatus{
		...
		MtlsAuthorino:      r.mtlsAuthorino(kObj, state),
		MtlsLimitador:      r.mtlsLimitador(kObj, state),
	}
...
func (r *KuadrantStatusUpdater) mtlsAuthorino(kObj *kuadrantv1beta1.Kuadrant, state *sync.Map) *bool {
...
func (r *KuadrantStatusUpdater) mtlsLimitador(kObj *kuadrantv1beta1.Kuadrant, state *sync.Map) *bool {
