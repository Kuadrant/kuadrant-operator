...
func (l *LimitadorIstioSidecarReconciler) Subscription() *controller.Subscription {
...
func (l *LimitadorIstioSidecarReconciler) Run(baseCtx context.Context, _ []controller.ResourceEvent, topology *machinery.Topology, _ error, _ *sync.Map) error {
	logger := controller.LoggerFromContext(baseCtx).WithName("LimitadorIstioSidecarReconciler")
