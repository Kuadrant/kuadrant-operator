		...
		},
		{
			...
			expectedActions: []wasm.ActionSpec{
				// Request phase action (Reserve)
				{
					...
					Scope:                "my-ns/my-route",
					ReservationAmount:    "uint(uint(2000))",
					ReservationTTL:       "duration('30s')",
					ReservationStorePath: "kuadrant.internal.reservation.tokenlimit_myTokenLimit__d681f6c3",
					ConditionalData: []wasm.ConditionalData{
						{
							Predicates: []string{},
							Data: []wasm.DataType{
