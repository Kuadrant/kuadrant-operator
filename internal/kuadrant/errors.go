...
func (e ErrTargetNotFound) Reason() gatewayapiv1.PolicyConditionReason {
	return gatewayapiv1.PolicyConditionReason(gatewayapiv1.PolicyReasonTargetNotFound)
}
...
func (e ErrInvalid) Reason() gatewayapiv1.PolicyConditionReason {
	return gatewayapiv1.PolicyConditionReason(gatewayapiv1.PolicyReasonInvalid)
}
...
func (e ErrConflict) Reason() gatewayapiv1.PolicyConditionReason {
	return gatewayapiv1.PolicyConditionReason(gatewayapiv1.PolicyReasonConflicted)
}
...
func IsTargetNotFound(err error) bool {
	return reasonForError(err) == gatewayapiv1.PolicyConditionReason(gatewayapiv1.PolicyReasonTargetNotFound)
}
