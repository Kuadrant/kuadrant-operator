...
// RatelimitReserveServiceTimeout returns the configured timeout for the ratelimit-reserve-service.
func RatelimitReserveServiceTimeout() string {
	return env.GetString("RATELIMIT_RESERVE_SERVICE_TIMEOUT", "100ms")
}

// RatelimitReserveServiceFailureMode returns the configured failure mode for the ratelimit-reserve-service.
...
// RatelimitCommitServiceTimeout returns the configured timeout for the ratelimit-commit-service.
func RatelimitCommitServiceTimeout() string {
	return env.GetString("RATELIMIT_COMMIT_SERVICE_TIMEOUT", "100ms")
}

// RatelimitCommitServiceFailureMode returns the configured failure mode for the ratelimit-commit-service.
