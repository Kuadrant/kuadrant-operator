...
IMG=quay.io/kuadrant/kuadrant-operator:v1.0.2-dev3
BUNDLE_VERSION=1.0.2-dev3
BUNDLE_IMG=quay.io/kuadrant/kuadrant-operator-bundle:v1.0.2-dev3
CATALOG_IMG=quay.io/kuadrant/kuadrant-operator-catalog:v1.0.2-dev3
CHANNELS=alpha
