...
.PHONY: verify-kuadrant-controller-manifests
verify-kuadrant-controller-manifests: kuadrant-controller-manifests ## Verify kuadrant controller manifests update.
	git diff --exit-code ./kuadrantcontrollermanifests/autogenerated
	[ -z "$$(git ls-files --other --exclude-standard --directory --no-empty-directory ./kuadrantcontrollermanifests/autogenerated)" ]
