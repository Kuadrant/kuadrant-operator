...
func (x *PingRequest) Reset() {
	*x = PingRequest{}
	mi := &file_v0_kuadrant_proto_msgTypes[0]
...
func (*PingRequest) Descriptor() ([]byte, []int) {
	return file_v0_kuadrant_proto_rawDescGZIP(), []int{0}
}
...
func (x *PongResponse) Reset() {
	*x = PongResponse{}
	mi := &file_v0_kuadrant_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PongResponse) Descriptor() ([]byte, []int) {
	return file_v0_kuadrant_proto_rawDescGZIP(), []int{1}
}
...
func (x *ResolveRequest) Reset() {
	*x = ResolveRequest{}
	mi := &file_v0_kuadrant_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ResolveRequest) Descriptor() ([]byte, []int) {
	return file_v0_kuadrant_proto_rawDescGZIP(), []int{2}
}
...
func (x *ResolveResponse) Reset() {
	*x = ResolveResponse{}
	mi := &file_v0_kuadrant_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ResolveResponse) Descriptor() ([]byte, []int) {
	return file_v0_kuadrant_proto_rawDescGZIP(), []int{3}
}
...
func (x *Event) Reset() {
	*x = Event{}
	mi := &file_v0_kuadrant_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Event) Descriptor() ([]byte, []int) {
	return file_v0_kuadrant_proto_rawDescGZIP(), []int{4}
}
...
var File_v0_kuadrant_proto protoreflect.FileDescriptor

const file_v0_kuadrant_proto_rawDesc = "" +
	"\n" +
	"\x11v0/kuadrant.proto\x12\vkuadrant.v0\x1a\"v0/google/protobuf/timestamp.proto\x1a\x1ev0/google/protobuf/empty.proto\x1a\x0fv0/policy.proto\x1a\x0fv0/common.proto\";\n" +
	"\vPingRequest\x12,\n" +
	...
	"\aResolve\x12\x1b.kuadrant.v0.ResolveRequest\x1a\x1c.kuadrant.v0.ResolveResponse\"\x00B\x05Z\x03/v0b\x06proto3"

var (
	file_v0_kuadrant_proto_rawDescOnce sync.Once
	file_v0_kuadrant_proto_rawDescData []byte
)

func file_v0_kuadrant_proto_rawDescGZIP() []byte {
	file_v0_kuadrant_proto_rawDescOnce.Do(func() {
		file_v0_kuadrant_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_v0_kuadrant_proto_rawDesc), len(file_v0_kuadrant_proto_rawDesc)))
	})
	return file_v0_kuadrant_proto_rawDescData
}

var file_v0_kuadrant_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_v0_kuadrant_proto_goTypes = []any{
...
var file_v0_kuadrant_proto_depIdxs = []int32{
...
func init() { file_v0_kuadrant_proto_init() }
func file_v0_kuadrant_proto_init() {
	if File_v0_kuadrant_proto != nil {
		return
	}
	file_v0_policy_proto_init()
	file_v0_common_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_v0_kuadrant_proto_rawDesc), len(file_v0_kuadrant_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_v0_kuadrant_proto_goTypes,
		DependencyIndexes: file_v0_kuadrant_proto_depIdxs,
		MessageInfos:      file_v0_kuadrant_proto_msgTypes,
	}.Build()
	File_v0_kuadrant_proto = out.File
	file_v0_kuadrant_proto_goTypes = nil
	file_v0_kuadrant_proto_depIdxs = nil
}
