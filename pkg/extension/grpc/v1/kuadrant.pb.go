...
type RegisterUpstreamMethodRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Policy        *Policy                `protobuf:"bytes,1,opt,name=policy,proto3" json:"policy,omitempty"`
...
func (x *RegisterUpstreamMethodRequest) Reset() {
	*x = RegisterUpstreamMethodRequest{}
	mi := &file_v1_kuadrant_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RegisterUpstreamMethodRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisterUpstreamMethodRequest) ProtoMessage() {}

func (x *RegisterUpstreamMethodRequest) ProtoReflect() protoreflect.Message {
	mi := &file_v1_kuadrant_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RegisterUpstreamMethodRequest.ProtoReflect.Descriptor instead.
func (*RegisterUpstreamMethodRequest) Descriptor() ([]byte, []int) {
	return file_v1_kuadrant_proto_rawDescGZIP(), []int{10}
}

func (x *RegisterUpstreamMethodRequest) GetPolicy() *Policy {
	if x != nil {
		return x.Policy
	}
	return nil
...
func (x *RegisterUpstreamMethodRequest) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *RegisterUpstreamMethodRequest) GetService() string {
	if x != nil {
		return x.Service
	}
	return ""
...
func (x *RegisterUpstreamMethodRequest) GetMethod() string {
	if x != nil {
		return x.Method
	}
	return ""
...
const file_v1_kuadrant_proto_rawDesc = "" +
	...
	"\x10cleared_mutators\x18\x02 \x01(\x05R\x0fclearedMutators\"\x90\x01\n" +
	"\x1dRegisterUpstreamMethodRequest\x12+\n" +
	...
	"\x0eDOMAIN_REQUEST\x10\x022\xef\x03\n" +
	...
	"\vClearPolicy\x12\x1f.kuadrant.v1.ClearPolicyRequest\x1a .kuadrant.v1.ClearPolicyResponse\"\x00\x12^\n" +
	"\x16RegisterUpstreamMethod\x12*.kuadrant.v1.RegisterUpstreamMethodRequest\x1a\x16.google.protobuf.Empty\"\x00B\x05Z\x03/v1b\x06proto3"
...
var file_v1_kuadrant_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_v1_kuadrant_proto_goTypes = []any{
	...
	(*RegisterUpstreamMethodRequest)(nil), // 11: kuadrant.v1.RegisterUpstreamMethodRequest
	(*timestamp.Timestamp)(nil),           // 12: google.protobuf.Timestamp
	(*Policy)(nil),                        // 13: kuadrant.v1.Policy
	(*v1alpha1.Value)(nil),                // 14: google.api.expr.v1alpha1.Value
	(*status.Status)(nil),                 // 15: google.rpc.Status
	(*Metadata)(nil),                      // 16: kuadrant.v1.Metadata
	(*empty.Empty)(nil),                   // 17: google.protobuf.Empty
}
var file_v1_kuadrant_proto_depIdxs = []int32{
	12, // 0: kuadrant.v1.PingRequest.out:type_name -> google.protobuf.Timestamp
	12, // 1: kuadrant.v1.PongResponse.in:type_name -> google.protobuf.Timestamp
	13, // 2: kuadrant.v1.ResolveRequest.policy:type_name -> kuadrant.v1.Policy
	14, // 3: kuadrant.v1.ResolveResponse.cel_result:type_name -> google.api.expr.v1alpha1.Value
	7,  // 4: kuadrant.v1.SubscribeResponse.event:type_name -> kuadrant.v1.Event
	15, // 5: kuadrant.v1.SubscribeResponse.error:type_name -> google.rpc.Status
	16, // 6: kuadrant.v1.Event.metadata:type_name -> kuadrant.v1.Metadata
	13, // 7: kuadrant.v1.RegisterMutatorRequest.policy:type_name -> kuadrant.v1.Policy
	0,  // 8: kuadrant.v1.RegisterMutatorRequest.domain:type_name -> kuadrant.v1.Domain
	13, // 9: kuadrant.v1.ClearPolicyRequest.policy:type_name -> kuadrant.v1.Policy
	13, // 10: kuadrant.v1.RegisterUpstreamMethodRequest.policy:type_name -> kuadrant.v1.Policy
	1,  // 11: kuadrant.v1.ExtensionService.Ping:input_type -> kuadrant.v1.PingRequest
	6,  // 12: kuadrant.v1.ExtensionService.Subscribe:input_type -> kuadrant.v1.SubscribeRequest
	3,  // 13: kuadrant.v1.ExtensionService.Resolve:input_type -> kuadrant.v1.ResolveRequest
	8,  // 14: kuadrant.v1.ExtensionService.RegisterMutator:input_type -> kuadrant.v1.RegisterMutatorRequest
	9,  // 15: kuadrant.v1.ExtensionService.ClearPolicy:input_type -> kuadrant.v1.ClearPolicyRequest
	11, // 16: kuadrant.v1.ExtensionService.RegisterUpstreamMethod:input_type -> kuadrant.v1.RegisterUpstreamMethodRequest
	2,  // 17: kuadrant.v1.ExtensionService.Ping:output_type -> kuadrant.v1.PongResponse
	5,  // 18: kuadrant.v1.ExtensionService.Subscribe:output_type -> kuadrant.v1.SubscribeResponse
	4,  // 19: kuadrant.v1.ExtensionService.Resolve:output_type -> kuadrant.v1.ResolveResponse
	17, // 20: kuadrant.v1.ExtensionService.RegisterMutator:output_type -> google.protobuf.Empty
	10, // 21: kuadrant.v1.ExtensionService.ClearPolicy:output_type -> kuadrant.v1.ClearPolicyResponse
	17, // 22: kuadrant.v1.ExtensionService.RegisterUpstreamMethod:output_type -> google.protobuf.Empty
