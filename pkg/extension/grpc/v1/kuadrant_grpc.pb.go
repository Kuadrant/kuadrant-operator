...
const (
	...
	ExtensionService_RegisterUpstreamMethod_FullMethodName = "/kuadrant.v1.ExtensionService/RegisterUpstreamMethod"
)
...
type ExtensionServiceClient interface {
	...
	// Register an upstream gRPC service for a policy
	RegisterUpstreamMethod(ctx context.Context, in *RegisterUpstreamMethodRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *extensionServiceClient) RegisterUpstreamMethod(ctx context.Context, in *RegisterUpstreamMethodRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, ExtensionService_RegisterUpstreamMethod_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ExtensionServiceServer interface {
	...
	// Register an upstream gRPC service for a policy
	RegisterUpstreamMethod(context.Context, *RegisterUpstreamMethodRequest) (*empty.Empty, error)
...
func (UnimplementedExtensionServiceServer) RegisterUpstreamMethod(context.Context, *RegisterUpstreamMethodRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterUpstreamMethod not implemented")
}
...
func _ExtensionService_RegisterUpstreamMethod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegisterUpstreamMethodRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExtensionServiceServer).RegisterUpstreamMethod(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExtensionService_RegisterUpstreamMethod_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExtensionServiceServer).RegisterUpstreamMethod(ctx, req.(*RegisterUpstreamMethodRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ExtensionService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RegisterUpstreamMethod",
			Handler:    _ExtensionService_RegisterUpstreamMethod_Handler,
		},
	},
