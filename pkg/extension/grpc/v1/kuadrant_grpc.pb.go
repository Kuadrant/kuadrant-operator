...
func (UnimplementedExtensionServiceServer) RegisterActionMethod(context.Context, *RegisterActionMethodRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterActionMethod not implemented")
}
func (UnimplementedExtensionServiceServer) PipelineCommit(context.Context, *PipelineCommitRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PipelineCommit not implemented")
}
