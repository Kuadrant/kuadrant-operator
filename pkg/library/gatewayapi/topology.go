...
func NewGatewayAPITopology(gateways []*gatewayapiv1.Gateway, routes []*gatewayapiv1.HTTPRoute, policies []GatewayAPIPolicy, logger logr.Logger) (*GatewayAPITopology, error) {
	...
	return &GatewayAPITopology{graph, logger}, nil
}
