...
func IsTargetRefHTTPRoute(targetRef gatewayapiv1alpha2.NamespacedPolicyTargetReference) bool {
	return targetRef.Group == (gatewayapiv1.GroupName) && targetRef.Kind == ("HTTPRoute")
}

func IsTargetRefGateway(targetRef gatewayapiv1alpha2.NamespacedPolicyTargetReference) bool {
