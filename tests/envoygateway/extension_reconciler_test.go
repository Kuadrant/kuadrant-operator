...
var _ = Describe("wasm controller", func() {
	...
	Context("Source Policy Locators", func() {
		It("EnvoyExtensionPolicy config includes source policy locators for single and merged RateLimitPolicy", func(ctx SpecContext) {
		...
		It("EnvoyExtensionPolicy config includes source policy locators for AuthPolicy", func(ctx SpecContext) {
			routeName := "test-route"
