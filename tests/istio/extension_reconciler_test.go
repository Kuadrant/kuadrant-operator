...
// defaultWasmServices returns the wasm services expected in the config
// generated by the extension reconciler for a gateway/route.
func defaultWasmServices(logger logr.Logger) map[string]wasm.Service {
	return map[string]wasm.Service{
	...
	Context("Basic tests", func() {
		...
		It("Simple RLP targeting HTTPRoute creates envoyfilter", func(ctx SpecContext) {
			...
			Expect(existingWASMConfig).To(Equal(&wasm.Config{
				...
				Services:          defaultWasmServices(logger),
